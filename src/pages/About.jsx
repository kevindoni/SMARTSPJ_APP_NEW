...
const CHANGELOG = [
  {
    ...
    changes: [
      ...
      { type: 'fix', text: '.arkas-key kosong/rusak dari upgrade v1.7.3 dihapus otomatis, fallback ke .env' },
      { type: 'fix', text: 'loadSecurePassword() tidak return early saat .arkas-key decrypt hasil kosong' },
  ...
  },
  {
    ...
    changes: [
      { type: 'new', text: 'Dashboard statistik, Revenue Chart, Welcome State' },
      ...
      { type: 'new', text: 'Backup & Restore, Export Multi-sheet' },
      { type: 'new', text: 'Tema terpusat, custom scrollbar, auto-updater dengan UI' },
      { type: 'new', text: 'Integrasi ARKAS (SQLCipher) dengan 6 lokasi deteksi' },
      { type: 'imp', text: 'Password ke .env, TLS enabled, konsistensi UI & font' },
      { type: 'imp', text: 'PDF export Times New Roman, alert diganti toast' },
      { type: 'imp', text: 'Versi dinamis, hapus debug code, dead code cleanup' },
      { type: 'fix', text: '60+ bug fix: NaN, crash, double-count, timezone, filter, dll.' },
    ],
  },
];
